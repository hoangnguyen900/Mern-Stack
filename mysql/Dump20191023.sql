...
CREATE TABLE `answer_record` (
  ...
  KEY `FK_2_idx` (`question_table_id`),
  KEY `FK_3_idx` (`question_id`),
  KEY `FK_4_idx` (`choice_id`),
  CONSTRAINT `FK_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_2` FOREIGN KEY (`question_table_id`) REFERENCES `question_table` (`id`),
  CONSTRAINT `FK_3` FOREIGN KEY (`question_id`) REFERENCES `question` (`id`),
  CONSTRAINT `FK_4` FOREIGN KEY (`choice_id`) REFERENCES `question_choices` (`id`)
...
INSERT INTO `answer_record` (`id`, `user_id`, `question_table_id`, `question_id`, `choice_id`) VALUES (1,1,1,1,1),(2,1,1,1,1),(3,1,1,1,3),(1,1,1,2,4),(2,1,1,2,5),(3,1,1,2,5),(1,1,1,3,6),(2,1,1,3,7),(3,1,1,3,7),(1,1,1,280,354),(2,1,1,280,355),(3,1,1,280,356),(1,1,1,295,378),(2,1,1,295,379),(3,1,1,295,379),(1,1,1,322,563),(2,1,1,322,564),(3,1,1,322,564);
...
INSERT INTO `question` (`id`, `question`, `time`) VALUES (1,'what is dota?',30),(2,'aaa',20),(3,'bbb',20),(4,'what is a?',20),(5,'what is n in math?',20),(6,'tesing quiz',30),(232,'here is the test from react',30),(233,'test',30),(234,'here is the test from react',30),(235,'here is the test from react',30),(236,'here is the test from react',30),(237,'here is the test from react',30),(238,'here is the test from react',30),(239,'here is the test from react',30),(240,'here is the test from react',30),(241,'haha',30),(242,'haha',30),(243,'what is dota',20),(244,'what is dota',20),(245,'what is dota',20),(246,'what is dota',20),(247,'what is dota',20),(248,'what is dota',20),(249,'what is dota',20),(250,'what is dota',20),(251,'what is dota',20),(252,'what is dota',20),(253,'what is dota',20),(254,'what is dota',20),(255,'here is the test from react',30),(256,'here is the test from react1111',30),(257,'test',30),(258,'here is the test from react',30),(259,'redux',30),(260,'test',30),(261,'here is the test from react',30),(262,'redux',30),(263,'here is the test from react',30),(264,'here is the test from react',30),(265,'redux',30),(266,'here is the test from react',30),(267,'test',30),(268,'123',30),(269,'123123',30),(270,'redux',30),(271,'asdasd',30),(272,'aaaaa',30),(273,'123',30),(274,'redux',30),(275,'123123',30),(276,'redux',30),(277,'test',30),(278,'redux',30),(279,'redux',30),(280,'redux',30),(295,'here is the test from react ',30),(297,'here is the test from react',30),(298,'Tt',30),(299,'Tt',30),(300,'here is the test from react',30),(301,'here is the test from react',30),(302,'here is the test from react',30),(305,'here is the test from react',30),(322,'here is the test from react',15),(324,'here is the test from react and update',30),(325,'here is the test from react aa',30),(326,'aaaaa',30);
...
INSERT INTO `question_table` (`id`, `code`, `title`, `grade_begin`, `grade_end`, `level`, `played`, `subject_id`, `image`, `is_public`, `admin`) VALUES (1,123456,'DOTA',1,4,1,1000,1,NULL,1,1),(2,NULL,'1',NULL,NULL,1,1,1,NULL,1,1),(3,NULL,'Testing for quiz',NULL,NULL,NULL,0,2,NULL,NULL,1),(4,NULL,'Testing for quiz 2',NULL,NULL,NULL,0,2,NULL,NULL,1),(5,NULL,'Testing for quiz 3',NULL,NULL,NULL,0,2,NULL,NULL,1),(6,NULL,'Testing for quiz 4',NULL,NULL,NULL,0,2,NULL,NULL,1),(7,NULL,'Testing for quiz 5',NULL,NULL,NULL,0,1,NULL,NULL,1),(8,NULL,'Testing for quiz',NULL,NULL,NULL,0,2,NULL,NULL,1),(9,NULL,'Testing for quiz',NULL,NULL,NULL,0,2,NULL,NULL,1),(10,NULL,'Testing for quiz',NULL,NULL,NULL,0,2,NULL,NULL,1),(11,NULL,'Testing for quiz',NULL,NULL,NULL,0,2,NULL,NULL,1),(12,NULL,'Testing for quiz 2',NULL,NULL,NULL,0,2,NULL,NULL,1),(14,NULL,'Testing for quiz 2',NULL,NULL,NULL,0,2,NULL,NULL,1),(15,NULL,'Testing for quiz',NULL,NULL,NULL,0,2,NULL,NULL,1),(16,NULL,'Testing for quiz 4',NULL,NULL,NULL,0,2,NULL,NULL,1),(17,NULL,'Ttt',NULL,NULL,NULL,0,2,NULL,NULL,1),(18,NULL,'Testing for quiz',NULL,NULL,NULL,0,2,NULL,NULL,1),(19,NULL,'hello from postman',NULL,NULL,NULL,0,1,NULL,NULL,3),(20,NULL,'hello from postman',NULL,NULL,NULL,0,1,NULL,NULL,3),(21,NULL,'Testing for quiz',NULL,NULL,NULL,0,2,NULL,NULL,3),(22,NULL,'Testing for quiz 2',NULL,NULL,NULL,0,2,NULL,NULL,1),(23,NULL,'lien minh',NULL,NULL,NULL,0,1,NULL,NULL,1);
...
INSERT INTO `questiontable_question` (`question_table_id`, `question_id`) VALUES (1,1),(1,2),(1,3),(1,280),(1,295),(16,297),(17,298),(17,299),(21,300),(22,301),(22,302),(22,305),(1,322),(23,326);
...
-- Dump completed on 2019-10-23 13:51:00

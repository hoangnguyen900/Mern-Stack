            ...
            <div className="my-quiz-control-container">
                <div className="quiz-control-header">
                    <div className="header-image">
                        <img alt="header" className="header-img" src={require("../../../../../../utils/QuizThumbnail/images/thumbnail.jpg")} />
                    </div>
                    <div className="header-info">
                        ...
                        <div className="grade-and-plays">
                            <div className="grade">
                                <span><FontAwesomeIcon icon={faBook} color="#6B7C93" /></span>
                                1 st grade - 2nd grade
                            </div>
                            <div className="plays">
                                <span><FontAwesomeIcon icon={faPlay} color="#6B7C93" /></span>
                                Played 4 times
                            </div>
                        </div>
                        <div className="subject">
                            <span><FontAwesomeIcon icon={faAtlas} color="#6B7C93" /></span>
                            Physic
                        </div>
                    </div>
                </div>
                <div className="quiz-control-action-hosting">
                    <div className="action-group">
                        <div className="action-group-info">
                            <div className="action-name">
                                <span><FontAwesomeIcon icon={faUsers} color="#868790" /></span>
                                Host a game
                            </div>
                    ...
                    <div className="action-group">
                        <div className="action-group-info">
                            <div className="action-name">
                                <span><FontAwesomeIcon icon={faUser} color="#868790" /></span>
                                Solo Practice
                            </div>
                            <div className="explain-action">
                                <span>
                ...
                <div className="quiz-control-action-drafting">
                ...
                <div className="quiz-control-questions">
                    <div className="questions-group-info">
                        <div className="question-number">
                            <span><FontAwesomeIcon icon={faComments} /></span>4 Questions
                        </div>
